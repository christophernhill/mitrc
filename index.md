...
| | | |
| <a id="subMIT">subMIT</a> | [http://submit04.mit.edu/submit-users-guide/index.html](http://submit.mit.edu) | [http://submit04.mit.edu/submit-users-guide/index.html](subMIT.mit.edu) is a batch submission interface to on- and off-campus computing resources including the Open Science Grid. It is operated by the MIT Laboratory for Nuclear Science and is intended to be available for anyone on campus. Further information is available from [pra@mit.edu](mailto:pra@mit.edu).
| | |
